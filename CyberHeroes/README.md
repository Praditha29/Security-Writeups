...
<img alt="image" src="images/SimpleCTF1.png" />
Two ports open, ssh and http.<br><br>
Let’s paste the ip address in firefox and see what’s open: 
<img alt="image" src="images/SimpleCTF1.png" /><br>
<img alt="image" src="images/SimpleCTF1.png" /><br>
Cool page right?<br>
Let’s see what’s in login page: <br>
<img alt="image" src="images/SimpleCTF1.png" /><br>
...
Let’s bruteforce now:<br>
```hydra -L /usr/share/wordlists/rockyou.txt -P /usr/share/wordlists/rockyou.txt  -vV 127.0.0.1 http-post-form "/admin/login.php:username=^USER^&password=^PASS^:F=Incorrect Password, try again" -t 12 -f```<br>
...
Uhhh I can’t really understand but I know that I got the username and password. I think the password is just written in reverse but let me check with chatgpt.<br>
<img alt="image" src="images/SimpleCTF1.png" /><br>
Haha! Gotcha!<br>
Username: h3ck3rBoi <br>
Password: SuperSecret@12345<br>
Do not copy paste. It doesn’t accept sometimes. I typed it and got the flag! <br>
<img alt="image" src="images/SimpleCTF1.png" /><br>
