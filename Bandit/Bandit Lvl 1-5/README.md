...
Level 0:
In this challenge, I had to connect to bandit.labs.overthewire.org on port 2220 using ssh. <br>
Username: bandit0<br>
Password: bandit0<br>
...
“This type of approach has a lot of misunderstanding because using - as an argument refers to STDIN/STDOUT i.e dev/stdin or dev/stdout .So if you want to open this type of file you have to specify the full location of the file such as ./- .For eg. , if you want to see what is in that file use cat ./-“<br>
So the command was: cat ./-<br>
<img alt="image" src="images/Bandit3.png"/><br><br>

Level 2 -> Level 3<br>
This level says: “The password for the next level is stored in a file called<br>
 --spaces in this filename-- located in the home directory”<br>
...
Level 3 -> Level 4<br>
This level said that the password was stored in a hidden file in a directory inhere.<br>
Hidden directories are not listed when ls is used.<br>
So, I used ls -la to list all the hidden directories and files.<br>
...
Flag for human-readable format: -readable<br>
Flag for 1033 bytes size: -size 1033c<br>
Flag for non executable: ! -executable<br>
